...
// AAA #include <User_Setup.h>           // Default setup is root library folder
...
// AAA #include <User_Setups/Setup206_LilyGo_T_Display_S3.h>     // For the LilyGo T-Display S3 based ESP32S3 with ST7789 170 x 320 TFT
